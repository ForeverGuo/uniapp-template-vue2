...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_ENV":"development","VUE_APP_NAME":"UNI-APP快速开发框架","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var storageKey = 'DEFAULT';
var storage = {
  // 设置
  setStorage: function setStorage(key, value) {
    var storage = uni.getStorageSync(storageKey) || {};
    storage[key] = value;
